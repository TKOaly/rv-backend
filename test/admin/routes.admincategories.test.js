...
describe(
	...
	() => {
		...
		describe(
			...
			() => {
				it(
					'should fail with a nonexisting category',
					async () => {
						const res = await chai
							.request(server)
				...
				it(
					'should return the deleted category and moved items',
					async () => {
						const res = await chai
							.request(server)
				...
				it(
					'should move items to the default category',
					async () => {
				...
				it(
					'should fail with the default category',
					async () => {
						const res = await chai
							.request(server)
