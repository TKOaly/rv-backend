	...
	() => {
		...
		describe(
			...
			() => {
				...
				it(
					'should return 404 on nonexistent box',
					async () => {
						const res = await chai
							.request(server)
		...
		describe(
			...
			() => {
				...
				it(
					'should error if box barcode is already taken',
					async () => {
						const res = await chai
							.request(server)
							.post('/api/v1/admin/boxes')
		...
		describe(
			...
			() => {
				...
				it(
					'should error on nonexistent box',
					async () => {
						const res = await chai
							.request(server)
		...
		describe(
			...
			() => {
				it(
					'should fail on nonexisting boxes',
					async () => {
						const res = await chai
							.request(server)
				...
				it(
					'should update the number of items',
					async () => {
				...
				it(
					'should update the sell and buy prices of the product',
					async () => {
						const initial_res = await chai
							.request(server)
							.get('/api/v1/admin/boxes/01880335')
