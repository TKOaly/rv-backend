	...
	() => {
		...
		describe(
			...
			() => {
				...
				it(
					'should deny changing username to one already taken',
					async () => {
						const res = await chai
							.request(server)
							.patch('/api/v1/user')
				...
				it(
					'should deny changing email to one already taken',
					async () => {
						const res = await chai
							.request(server)
							.patch('/api/v1/user')
				...
				it(
					'should error if no fields are specified',
					async () => {
						const res = await chai
							.request(server)
							.patch('/api/v1/user')
		...
		describe(
			...
			() => {
				...
				it(
					'should create an event into deposit history',
					async () => {
				...
				it(
					'should error on depositing a negative amount',
					async () => {
						const res = await chai
							.request(server)
							.post('/api/v1/user/deposit')
